...
function startDrawing() {
	drawInterval = setInterval(worldTimer,fps)
}

function worldTimer(){
	App_Info.world_timer = App_Info.world_timer + 1
	//console.log(App_Info.world_timer)
	//if (App_Info.world_timer > 60){
	//	App_Info.world_timer = 0
	//}
}
...
function Print_Test(){
	...
	var jsonCircles = [
	{"name":"programme creation","x_axis":100,"y_axis":150,"s_width":80,"s_height":40,"width":80,"height":40,"pulse":1000,"load":650,"output":500,"error":50,"color":"red","id":0,"end":1},
	{"name":"contractor","x_axis":200,"y_axis":150,"s_width":80,"s_height":40,"width":80,"height":40,"pulse":200,"load":0,"output":1,"error":0,"color":"orange","id":1,"end":2},
	{"name":"technical assistants","x_axis":300,"y_axis":150,"s_width":80,"s_height":40,"width":80,"height":40,"pulse":1500,"load":0,"error":0,"output":0,"color":"red","id":2,"end":-1}
		];
	...
	App_Info.canvas
	    .on("click", function() {
	    	...
	    	startDrawing() //KEEP A RECORD OF THE WORLD TIMER
